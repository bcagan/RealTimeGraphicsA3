...
C:/VulkanSDK/1.3.268.0/Bin/glslc.exe shaderShadowInst.frag -o fragShadowInst.spv
C:/VulkanSDK/1.3.268.0/Bin/glslc.exe shader.frag -o frag.spv
C:/VulkanSDK/1.3.268.0/Bin/glslc.exe shaderInst.frag -o fragInst.spv
C:/VulkanSDK/1.3.268.0/Bin/glslc.exe shaderEnv.frag -o fragEnv.spv
C:/VulkanSDK/1.3.268.0/Bin/glslc.exe shaderInstEnv.frag -o fragInstEnv.spv
